...
채보 클리어로 갈립니다. 그래서 로컬 `scores.db` — 서버와 무관하게 모든 통과 플레이가
기록되는 곳 — 가 실질적으로 가장 중요한 소스입니다.
...
**맵을 추천합니다.** 플레이어의 기록에서 "채보 난이도 → 예상 정확도" 관계를 회귀해서,
90–93% / 95–97% / 98–100% 세 구간으로 나눠 제안합니다.
